...
import net.aolkzyeoer.draconagric.event.CastMagicEvents;
...
public final class ModNetwork {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(DoubleJumpPayload.TYPE, DoubleJumpPayload.STREAM_CODEC, (payload, context) -> context.enqueueWork(() -> {
            if (context.player() instanceof ServerPlayer serverPlayer) {
                CastMagicEvents.tryDoubleJump(serverPlayer);
            }
        }));
    }
}
